...
func (_m *MockTwitterWebAPI) FetchTweets(_a0 context.Context, _a1 string) ([]entity.Tweet, error) {
	ret := _m.Called(_a0, _a1)

	var r0 []entity.Tweet
	if rf, ok := ret.Get(0).(func(context.Context, string) []entity.Tweet); ok {
		r0 = rf(_a0, _a1)
	} else {
		if ret.Get(0) != nil {
...
type NewMockTwitterWebAPIT interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewMockTwitterWebAPI(t NewMockTwitterWebAPIT) *MockTwitterWebAPI {
